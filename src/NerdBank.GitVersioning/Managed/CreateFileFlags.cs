...
namespace NerdBank.GitVersioning.Managed
{
    internal enum CreateFileFlags : uint
    {
        ...
        ///     were all opened with the <see cref="FileShare.Delete" /> share mode. Subsequent open requests for the
        ///     file fail, unless the <see cref="FileShare.Delete" /> share mode is specified.
        /// </summary>
        ...
        ///     This flag cannot be used with the <c>CreationDisposition.CREATE_ALWAYS</c> flag. If the file is not a
