...
type internal ThisAssembly() =
  ...
  static member internal CustomTicks = global.System.DateTime(637509805729817056L, global.System.DateTimeKind.Utc)
...
{(thisAssemblyClass.GetValueOrDefault(true) ? $@"@System.CodeDom.Compiler.GeneratedCode(""{AssemblyVersionInfo.GeneratorName}"",""{AssemblyVersionInfo.GeneratorVersion}"")
@System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage
internal class ThisAssembly {{
  shared {{
    internal let AssemblyCompany string = ""company""
    internal let AssemblyFileVersion string = ""1.3.1.0""
    internal let AssemblyVersion string = ""1.3.0.0""
    internal let CustomBool bool = true
    internal let CustomString1 string = ""abc""
    internal let CustomString3 string = """"
    internal let CustomTicks System.DateTime = System.DateTime(637509805729817056L, System.DateTimeKind.Utc)
    internal let IsPrerelease bool = false
    internal let IsPublicRelease bool = false
    internal let RootNamespace string = """"
  }}
}}
" : string.Empty)}";
...
internal class ThisAssembly {{
  shared {{
    ...
    internal let IsPrerelease bool = false
    internal let IsPublicRelease bool = false
    internal let RootNamespace string = ""{rootNamespace}""
  }}
}}
";
