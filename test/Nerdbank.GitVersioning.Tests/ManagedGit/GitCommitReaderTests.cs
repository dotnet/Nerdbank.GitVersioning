...
public class GitCommitReaderTests
{
    ...
    public void ReadTest()
    {
        ...
        {
            GitCommit commit = GitCommitReader.Read(stream, GitObjectId.Parse("d56dc3ed179053abef2097d1120b4507769bcf1a"), readAuthor: true);
            ...
            GitSignature author = commit.Author.Value;
    ...
    public void ReadCommitWithThreeParents()
    {
        ...
        {
            GitCommit commit = GitCommitReader.Read(stream, GitObjectId.Parse("ab39e8acac105fa0db88514f259341c9f0201b22"), readAuthor: true);
